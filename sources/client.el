...
(setq insert-credit "LOCK WRITE INSERT Credit (AccountNumber INTEGER 5 Value INTEGER 100)")
(setq insert-debit "LOCK WRITE INSERT Debit (AccountNumber INTEGER 5 Value INTEGER 100)")
(setq default-search "LOCK READ PROJECT ALL Account SELECT AccountNumber = 5")
(setq default-sum "LOCK READ PROJECT SUM(AccountNumber INTEGER) Account SELECT AccountNumber = 5")
(setq default-minus "LOCK WRITE UPDATE Account SET AccountNumber (PROJECT SUM(Value INTEGER) Credit SELECT AccountNumber = 5 - PROJECT SUM(Value INTEGER) Debit SELECT AccountNumber = 5) SELECT AccountNumber = 5")
(setq project-debit "LOCK READ PROJECT SUM(Value INTEGER) Credit SELECT AccountNumber = 5")
(setq project-credit "LOCK READ PROJECT SUM(Value INTEGER) Debit SELECT AccountNumber = 5")
